...
fn main() {
    ...
    let bridgetown = world
        .ports
        .iter()
        .find(|p| p.name == "Bridgetown")
        .unwrap()
        .position;
    ...
    let mut prev = world.ships[id].position;
